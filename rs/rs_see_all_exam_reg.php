...
<html lang="en">
	<head>
		...
		<script language="JavaScript" type="text/javascript" src="./bamboo/call_reg_exam.js"></script>
        ...
        <link rel="stylesheet" type="text/css" media="all" href="./bamboo/call_reg_exam.css" />
	...
	<body>
        ...
        <div class="appl_container">
            <div class="appl_left_div" style="z-index:2;">
                ...
                <div class="appl_left_child_div" style="margin-top:0px;  font-size:1.2em">See all registered courses for exam</div>
            ...
            <div class="appl_right_div">  
                ...
                $prev_cAcademicDesc_ex = '';
                
                $table = search_starting_pt_crs($_REQUEST['vMatricNo']);?>
                
                <div class="appl_left_child_div" style="width:98%; margin:auto; height:90%; overflow-x:hidden; overflow-y:scroll; background-color:#eff5f0"><?php
                    ...
                    foreach ($table as &$value)
                    {
        				...
        				$stmt->execute();
        				$stmt->store_result();
        				$stmt->bind_result($cCourseId, $level, $cAcademicDesc_ex, $tSemester);
                        ...
                        while($stmt->fetch())
                        {
                            foreach ($table as &$value1)
                            {
                				...
                				if ($stmt_ex->num_rows > 0)
                				{
                                    ...
                                    if ($prev_cAcademicDesc_ex <> $cAcademicDesc_ex || ($prev_semester <> '' && $prev_semester <> $tSemester))
                                    {
                                        //if ($prev_level <> '' && $prev_level <> '')
                                        if ($prev_cAcademicDesc_ex <> '' && $prev_level <> '')
                                        {?>
                                            <div class="appl_left_child_div_child calendar_grid" style="font-weight:bold">
                                                ...
                                                <div style="flex:40%; padding-top:5px; padding-left:4px; height:35px; background-color: #ffffff; text-align:right;">
                                                    Total
                                                </div>
                            ...
                            $prev_cAcademicDesc_ex = $cAcademicDesc_ex;
                        }
                    }?>
                    ...
                    <label for="regCourses<?php echo $c ?>">
                        <div class="appl_left_child_div_child calendar_grid" style="font-weight:bold">
                            <div style="flex:5%; padding-top:5px; padding-right:4px; height:35px; background-color: #ffffff; text-align:right; margon-top:5px;"></div>

                            <div style="flex:10%; padding-top:5px; padding-left:4px; height:35px; background-color: #ffffff"></div>
                            ...
                            <div style="flex:10%; padding-top:5px; padding-right:4px; height:35px; background-color: #ffffff; text-align:right;"><?php 
                                echo number_format($total_cost_all, 0, '', ',');?>
                            </div>
                        </div>
                    </label>
