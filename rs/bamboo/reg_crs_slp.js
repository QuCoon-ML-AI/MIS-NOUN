...
function chk_inputs()
{
    ...
    }else if (course_form.drp_crs.value == 1)
    {
        ...
        if (boxchk == 0)
        {
            caution_inform("Please select one or more courses to drop");
            return false;
        }				
        ...
        with (course_form)
        {
            ...
            formdata.append("cProgrammeId", cProgrammeId.value);
            formdata.append("conf", '1');
                
            formdata.append("edu_cat", edu_cat.value);
            formdata.append("res_ctry", res_ctry.value);
    ...
    with (course_form)
    {
        ...
        formdata.append("drp_crs", drp_crs.value);
        formdata.append("edu_cat", edu_cat.value);
    }
...
function opr_prep(ajax,formdata)
{
    ...
    ajax.open("POST", "back_end_crs_reg_slp");
