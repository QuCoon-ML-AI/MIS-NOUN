...
<script language="JavaScript" type="text/javascript">
	function chk_inputs()
    {
        ...
        formdata.append("ilin", recall_appl_loc.ilin.value);
        formdata.append("mm", recall_appl_loc.mm.value);
        formdata.append("sm", recall_appl_loc.sm.value);
        formdata.append("vApplicationNo",recall_appl_loc.vApplicationNo.value);
    ...
    function opr_prep(ajax,formdata)
    {
        ...
        ajax.open("POST", "opr_re_act_appl.php");
        ajax.send(formdata);
    }
...
<div id="container" style="position:relative"><?php
	...
	<div id="rtlft_std" style="position:relative;">
		<!-- InstanceBeginEditable name="EditRegion6" -->
            ...
            <div class="innercont_top">Re-activate Application</div>
            
            <form action="manage-result" method="post" name="recall_appl_loc" id="recall_appl_loc" enctype="multipart/form-data">
