...
<html lang="en">
	...
	<body><?php
		...
		if (!is_bool(strpos($Programme, '(d)')))
		{
			$Programme = "(".substr($Programme, 0, strlen(trim($Programme))-4).")";
		}
		
		if ($cEduCtgId == 'PSZ' OR $cEduCtgId == 'PGY')
		{
			//$vObtQualTitle = "(".substr($vObtQualTitle, 0, strlen($vObtQualTitle) - 1).") degree";
		}
